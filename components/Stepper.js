    ...
    return (
        <div key={index} 
          ...
          <div className='relative flex flex-col items-center text-teal-600'>
              ...
              {/* </div> */}
              {/* <div className={`abolute top-0 text-center mt-[4px] w-32 text-xs font-medium uppercase 
                ${step.highlighted ? "text-gray-900" : "text-gray-400"}`}> */}
                {/* Display description */}
                {/* {step.description}
              </div> */}
            </div>
              <div className={`flex-auto border-t-4 transition duration-500 ease-in-out  
                ${step.completed ? "border-[#00af9e]" : " border-gray-300"}`}>
                {/* display line */}
              </div>
        </div>
      )
